...
- Current-quarter EPS estimate: ${quote.fundamentals.estimatedQuarterEps || "N/A"}, growth: ${quote.fundamentals.estimatedQuarterEpsGrowth || "N/A"}
- Next-quarter EPS estimate: ${quote.fundamentals.estimatedNextQuarterEps || "N/A"}, growth: ${quote.fundamentals.estimatedNextQuarterEpsGrowth || "N/A"}
- Estimated annual gross profit: ${quote.fundamentals.estimatedAnnualGrossProfit || "N/A"}, growth: ${quote.fundamentals.estimatedAnnualGrossProfitGrowth || "N/A"}
- Estimated annual operating income: ${quote.fundamentals.estimatedAnnualOperatingIncome || "N/A"}, growth: ${quote.fundamentals.estimatedAnnualOperatingIncomeGrowth || "N/A"}
- Estimated annual EPS: ${quote.fundamentals.estimatedAnnualEps || "N/A"}, growth: ${quote.fundamentals.estimatedAnnualEpsGrowth || "N/A"}
- Estimated next annual EPS: ${quote.fundamentals.estimatedNextAnnualEps || "N/A"}, growth: ${quote.fundamentals.estimatedNextAnnualEpsGrowth || "N/A"}
...
Peter Lynch:
- Fair value: ${quote.peterLynch?.fairValueDisplay || "N/A"}
- Fair value / price: ${quote.peterLynch?.ratioDisplay || "N/A"}
- Growth assumption: ${quote.peterLynch?.growthRateDisplay || "N/A"}
...
- 本季度預估 EPS：${quote.fundamentals.estimatedQuarterEps || "N/A"}，成長：${quote.fundamentals.estimatedQuarterEpsGrowth || "N/A"}
- 下季度預估 EPS：${quote.fundamentals.estimatedNextQuarterEps || "N/A"}，成長：${quote.fundamentals.estimatedNextQuarterEpsGrowth || "N/A"}
- 本年度預估毛利：${quote.fundamentals.estimatedAnnualGrossProfit || "N/A"}，成長：${quote.fundamentals.estimatedAnnualGrossProfitGrowth || "N/A"}
- 本年度預估營業利益：${quote.fundamentals.estimatedAnnualOperatingIncome || "N/A"}，成長：${quote.fundamentals.estimatedAnnualOperatingIncomeGrowth || "N/A"}
- 本年度預估 EPS：${quote.fundamentals.estimatedAnnualEps || "N/A"}，成長：${quote.fundamentals.estimatedAnnualEpsGrowth || "N/A"}
- 下一年度預估 EPS：${quote.fundamentals.estimatedNextAnnualEps || "N/A"}，成長：${quote.fundamentals.estimatedNextAnnualEpsGrowth || "N/A"}
...
彼得林區指標：合理價 ${quote.peterLynch?.fairValueDisplay || "N/A"}；合理價 / 現價 ${quote.peterLynch?.ratioDisplay || "N/A"}；成長假設 ${quote.peterLynch?.growthRateDisplay || "N/A"}
