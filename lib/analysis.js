...
const fallbackProfile = {
	...
	supplyChain: {
		upstream: [
			{ name: "關鍵供應商", role: "提供核心零組件、原料或技術投入" },
			{ name: "代工/設備夥伴", role: "支援生產製造、封裝與設備供應" },
			{ name: "基礎設施供應鏈", role: "提供雲端、網通、能源或其他底層支援" },
		],
		downstream: [
			{ name: "企業客戶", role: "採購產品或服務，形成主要商業需求" },
			{ name: "終端需求", role: "反映最終市場採用與產品滲透率" },
			{ name: "通路夥伴", role: "協助銷售、部署或觸達最終客戶" },
		],
		note: "若公司未公開揭露完整上下游名單，這裡會先用代表性供應鏈角色整理。",
	},
...
export function getProfileForSymbol(symbol, snapshot) {
	...
	return {
		...
		supplyChain: staticProfile?.supplyChain || fallbackProfile.supplyChain,
